...
function Content52() {
  ...
  useEffect(() => {
    const scrollableDiv = tri1Ref.current;
    const tri1XInitial = scrollableDiv.getBoundingClientRect().y;
      ...
      // if (containerTop <= 0) {
        console.log("bro")
         ...
         debounce(function() {
          ...
          scrollableDiv.style.top = parseInt(scrollableDiv.style.top) - scrollAmount + "px";
        }, 50);
      // }
    };
    window
